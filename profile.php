...
print '<h1><center>View Own Profile</center></h1>
...
<strong>Member User Name:</strong> '.$currentusername.'<br />
<strong>Member First Name:</strong> '.$currentfirstname.'<br />
<strong>Member Last Name:</strong> '.$currentlastname.'<br />
<strong>Member Group:</strong> '.$row[group].'<br />
<strong>Date Joined:</strong> '.$row[date_joined].'<br />
<strong>Online Status: </strong><img src="'.$status.'" /><br /><br />
...
<a href="index.php?act=profile&amp;act2=reputation&amp;username='.$row[username].'">Change '.$currentusername.'\'s Reputation</a><br />
